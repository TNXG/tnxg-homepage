			...
			if (videoInfo) {
				...
				<div class="mt-6 relative rounded-lg border bg-card text-card-foreground shadow-sm mb-4">
					<div class="flex flex-col sm:flex-row h-[80%]">
						<div class="w-full sm:w-[180px] h-[200px] sm:h-auto flex-shrink-0 relative overflow-hidden">
							<img 
								src="${videoInfo.cover}" 
								alt="${videoInfo.title}" 
						...
						<div class="flex-1">
						  ...
						  <p class="text-sm text-muted-foreground line-clamp-2 sm:line-clamp-3">${videoInfo.desc}</p>
						</div>
